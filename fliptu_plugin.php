<?php
/*Plugin Name: Fliptu Management
Plugin URI: http://www.pixelcrayons.com
...
add_action('wp_enqueue_scripts', 'usm_wp_enqueue_scripts');
   ...
   function usm_wp_enqueue_scripts() {
		wp_enqueue_script(array('validate','jquery'));
...
//include file here
	if($_REQUEST['action']=='edit' || $_REQUEST['action']=='editData')
	{
